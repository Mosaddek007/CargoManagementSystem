...
namespace CargoManagementSystem
{
    public partial class Form17 : Form
    {
        ...
        private void Form17_Load(object sender, EventArgs e)
        {
            ...
            string query = "select id,bid,fcity,tcity,t_departure FROM cargoair";
            ...
            string query1 = "select id,bid,fcity,tcity,t_departure FROM appairorder";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(cs);
                string query = "Insert Into appairorder (id,bid,fcity,tcity,t_departure) values (@id,@bid,@fcity,@tcity,@t_departure)";
                SqlCommand cmd = new SqlCommand(query, con);
                con.Open();
                ...
                if (a > 0)
                {
                    ...
                    SqlCommand cmd2 = new SqlCommand("delete from cargoair where ID=@id", connection);
